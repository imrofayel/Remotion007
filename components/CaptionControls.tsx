...
import { Check, Eye, EyeOff, MousePointerClickIcon, Package2, Pencil, Trash, X } from 'lucide-react';
  ...
  return (
    <div className={cn("space-y-4", className)}>
      <div className="flex justify-between items-center">
        <h2 className="block font-medium text-2xl text-gray-300 mb-">Captions</h2>
